  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="hidden md:flex flex-col w-64 bg-[#363740] text-white flex-shrink-0">
        ...
        {/* Sidebar Footer Profile (Visible seulement si connecté) */}
        {user ? (
            ...
            <div className="p-4 border-t border-gray-700 text-center">
                <p className="text-xs text-gray-400 mb-2">Mode Invité</p>
            </div>
        )}
      </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="flex items-center justify-between px-8 py-4 bg-white shadow-sm h-20">
          ...
          <div className="flex items-center gap-6">
             ...
             {/* Auth Section: Profile/Logout OR Login Button */}
             <div className="flex items-center gap-4 border-l pl-6 border-gray-200">
               {user ? (
                   ...
                   <Link to="/login">
                       <Button variant="dark" className="!w-auto !py-2 !px-6 !text-xs">
                           Se connecter
                       </Button>
                   </Link>
               )}
